...
/**
 * Escapa caracteres especiais para uso em HTML (Previne XSS)
...
/**
 * Valida o nome do cliente (apenas letras e espaços)
...
function validarNome(nome) {
    ...
    // Permite apenas letras (incluindo acentos), espaços
    const regexNome = /^[a-zA-Zà-ÿÀ-Ý\s'-]{2,100}$/;
    return regexNome.test(nomeLimpo);
}

/**
 * Valida o telefone - exatamente 11 dígitos
